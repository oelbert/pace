...
class TranslateFinalCalculations(TranslatePhysicsFortranData2Py):
    def __init__(
        ...
        self.out_vars = {
            ...
            "qvapor0": {"serialname": "fin_qv0", "kend": namelist.npz, "mp3": True},
            "qliquid0": {"serialname": "fin_ql0", "kend": namelist.npz, "mp3": True},
            "qrain0": {"serialname": "fin_qr0", "kend": namelist.npz, "mp3": True},
            "qice0": {"serialname": "fin_qi0", "kend": namelist.npz, "mp3": True},
            "qsnow0": {"serialname": "fin_qs0", "kend": namelist.npz, "mp3": True},
            "qgraupel0": {"serialname": "fin_qg0", "kend": namelist.npz, "mp3": True},
            "dp0": {"serialname": "fin_dp0", "kend": namelist.npz, "mp3": True},
            "pt0": {"serialname": "fin_pt0", "kend": namelist.npz, "mp3": True},
            "u0": {"serialname": "fin_u0", "kend": namelist.npz, "mp3": True},
            "v0": {"serialname": "fin_v0", "kend": namelist.npz, "mp3": True},
            "w0": {"serialname": "fin_w0", "kend": namelist.npz, "mp3": True},
            "column_energy_change": {"serialname": "fin_dte", "mp3": True},
